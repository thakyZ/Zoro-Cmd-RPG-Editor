	...
	while (reroll)
	{
		...
		switch (menuItem)
		{
			...
			case "13":
				...
				reroll = true;
			case "14":
				cout << "This value has to be a NUMBER.\nFIGHTER=0,CLERIC=1,THIEF=2,BARD=3,ROUGE=4,TINKER=5,\nMAGE=6\nClass = ";
				cin >> valueItem;
				switch (valueItem)
				{
					default:
			...
			case "15":
				...
				switch (valueItem)
				{
					...
					case "1":
						...
						break;
					case "2":
						player1.race = DARKELF;
						break;
					case "3":
						player1.race = ANGEL;
						break;
					case "4":
						player1.race = MONGREL;
						break;
					case "5":
						player1.race = SHAMANI;
						break;
					case "6":
						player1.race = NIBELUNG;
						break;
					case "7":
						player1.race = UNDEAD;
						break;
